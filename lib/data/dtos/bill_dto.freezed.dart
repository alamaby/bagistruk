...
mixin _$BillDto {
 ...
 String get id; String get title;@JsonKey(name: 'total_amount') double get totalAmount; double get tax; double get service;@JsonKey(name: 'is_settled') bool get isSettled;@JsonKey(name: 'created_at') DateTime get createdAt;
...
@override
String toString() {
  return 'BillDto(id: $id, title: $title, totalAmount: $totalAmount, tax: $tax, service: $service, isSettled: $isSettled, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String title,@JsonKey(name: 'total_amount') double totalAmount, double tax, double service,@JsonKey(name: 'is_settled') bool isSettled,@JsonKey(name: 'created_at') DateTime createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title, @JsonKey(name: 'total_amount')  double totalAmount,  double tax,  double service, @JsonKey(name: 'is_settled')  bool isSettled, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BillDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title, @JsonKey(name: 'total_amount')  double totalAmount,  double tax,  double service, @JsonKey(name: 'is_settled')  bool isSettled, @JsonKey(name: 'created_at')  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _BillDto():
return $default(_that.id,_that.title,_that.totalAmount,_that.tax,_that.service,_that.isSettled,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title, @JsonKey(name: 'total_amount')  double totalAmount,  double tax,  double service, @JsonKey(name: 'is_settled')  bool isSettled, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _BillDto() when $default != null:
return $default(_that.id,_that.title,_that.totalAmount,_that.tax,_that.service,_that.isSettled,_that.createdAt);case _:
  return null;
...
class _BillDto extends BillDto {
  const _BillDto({required this.id, required this.title, @JsonKey(name: 'total_amount') required this.totalAmount, this.tax = 0, this.service = 0, @JsonKey(name: 'is_settled') this.isSettled = false, @JsonKey(name: 'created_at') required this.createdAt}): super._();
