...
@override
String toString() {
  return 'BillDto(id: $id, title: $title, totalAmount: $totalAmount, currencyCode: $currencyCode, tax: $tax, service: $service, isSettled: $isSettled, receiptDate: $receiptDate, createdAt: $createdAt, category: $category, origin: $origin, tags: $tags, participantPaymentStatuses: $participantPaymentStatuses)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title, @JsonKey(name: 'total_amount')  double totalAmount, @JsonKey(name: 'currency_code')  String currencyCode, @JsonKey(name: 'tax_amount')  double tax, @JsonKey(name: 'service_charge')  double service, @JsonKey(name: 'is_settled')  bool isSettled, @JsonKey(name: 'receipt_date')  DateTime? receiptDate, @JsonKey(name: 'created_at')  DateTime createdAt,  String category,  String origin, @JsonKey(name: 'bill_tags')  List<String> tags, @JsonKey(includeFromJson: false, includeToJson: false)  List<bool> participantPaymentStatuses)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BillDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title, @JsonKey(name: 'total_amount')  double totalAmount, @JsonKey(name: 'currency_code')  String currencyCode, @JsonKey(name: 'tax_amount')  double tax, @JsonKey(name: 'service_charge')  double service, @JsonKey(name: 'is_settled')  bool isSettled, @JsonKey(name: 'receipt_date')  DateTime? receiptDate, @JsonKey(name: 'created_at')  DateTime createdAt,  String category,  String origin, @JsonKey(name: 'bill_tags')  List<String> tags, @JsonKey(includeFromJson: false, includeToJson: false)  List<bool> participantPaymentStatuses)  $default,) {final _that = this;
switch (_that) {
case _BillDto():
return $default(_that.id,_that.title,_that.totalAmount,_that.currencyCode,_that.tax,_that.service,_that.isSettled,_that.receiptDate,_that.createdAt,_that.category,_that.origin,_that.tags,_that.participantPaymentStatuses);case _:
  throw StateError('Unexpected subclass');
...
@override@JsonKey(includeFromJson: false, includeToJson: false) List<bool> get participantPaymentStatuses {
